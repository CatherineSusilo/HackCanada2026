...
import { Plus, Trash2, Loader2, Mic, Edit3, BookOpen, BarChart3, ChevronDown, ChevronUp, Sparkles } from 'lucide-react';
                        ...
                        <div style={{ borderTop: '1px solid rgba(40, 30, 20, 0.15)', paddingTop: '16px' }}>
                          ...
                          <div className="flex flex-wrap gap-2">
                            ...
                            <button
                              ...
                              className="px-3 py-2 flex items-center gap-1.5 cursor-pointer transition-all disabled:opacity-50"
                              style={{ fontFamily: "'Patrick Hand', cursive", fontSize: '15px', color: 'rgba(80, 60, 120, 0.8)', background: 'rgba(120, 100, 160, 0.12)', border: '1px solid rgba(80, 60, 120, 0.25)' }}
                            >
                              {matchingVoice === char.id ? <><Loader2 className="w-3.5 h-3.5 animate-spin" /> matching...</> : <><Sparkles className="w-3.5 h-3.5" /> auto-match voice</>}
                            </button>
                            <button
